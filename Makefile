# Agentic - Graph-based workflow orchestration for autonomous AI agents.
...
challenge:
	../challenges/scripts/agentic_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Agentic - Graph-based workflow orchestration for autonomous AI agents."
	@echo ""
	@echo "Build & Test:"
